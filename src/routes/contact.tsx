      ...
      <section className="mx-auto w-full max-w-6xl px-6 pb-24 grid lg:grid-cols-[1fr_1.1fr] gap-8">
        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-border bg-card p-8 shadow-[var(--shadow-card)]">
            ...
            <div className="calendly-inline-widget w-full rounded-xl overflow-hidden" data-url="https://calendly.com/linm-revleadai/motor-ai-implementation?background_color=1a1511&text_color=ebefeb&primary_color=d5aa7d" style={{ minWidth: '320px', height: '700px' }} />
          </div>
